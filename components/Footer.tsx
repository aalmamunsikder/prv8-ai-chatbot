...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative pt-32 pb-12 px-6 overflow-hidden">
      {/* Background Glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-champagne-400/5 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="glass-heavy rounded-[3rem] p-12 md:p-20 relative overflow-hidden border border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between h-full">
              <div>
                <span className="font-serif text-5xl text-champagne-400 tracking-tighter block mb-6">LUMINA</span>
              ...
              <div className="glass-card p-8 rounded-2xl border border-white/5 bg-white/[0.02]">
                <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-champagne-400 mb-6">
                  Join the Waitlist
                </h4>
                <form className="relative group" onSubmit={(e) => e.preventDefault()}>
                  <input
                    ...
                    className="w-full bg-transparent border-b border-white/10 py-4 text-white placeholder-white/20 focus:outline-none focus:border-champagne-400 transition-colors pr-12 font-light"
                  />
                  <button
                    type="submit"
            ...
            <div className="lg:col-span-7 flex flex-col md:flex-row justify-between gap-12 lg:pl-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-12 w-full">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-4">
                    <a href="#" className="flex items-center gap-3 text-sm text-white/60 hover:text-champagne-400 transition-colors group">
              ...
              <div className="flex flex-col justify-end items-end">
                <button
                  onClick={scrollToTop}
                  className="group flex items-center justify-center w-14 h-14 rounded-full border border-white/10 hover:border-champagne-400/50 bg-white/5 hover:bg-champagne-400/10 transition-all duration-500"
                >
                  <ArrowUp className="w-5 h-5 text-white/50 group-hover:text-champagne-400 transition-colors" />
                </button>
              </div>
