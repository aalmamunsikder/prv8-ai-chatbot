                    ...
                    {bookingState === 'summary' && selectedHotel && (
                        <div className="space-y-6">
                            <div className="flex gap-4">
                                <img src={selectedHotel.image} alt={selectedHotel.name} className="w-24 h-24 rounded-xl object-cover border border-white/10" />
                                <div>
                            ...
                            <div className="space-y-3 bg-white/5 rounded-xl p-4 border border-white/5">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="text-white">Dec 12 - Dec 16</span>
                                </div>
                                <div className="flex justify-between text-sm">
                    ...
                    {bookingState === 'confirmed' && (
                        <div className="flex flex-col items-center text-center py-8">
                            ...
                            <button
                                ...
                                className="w-full bg-white/10 text-white py-4 rounded-xl font-medium text-sm hover:bg-white/20 transition-colors border border-white/5"
                            >
                                View Itinerary
                            </button>
                        </div>
