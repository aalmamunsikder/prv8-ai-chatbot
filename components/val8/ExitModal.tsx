        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    animate={{ scale: 1, y: 0 }}
                    exit={{ scale: 0.9, y: 20 }}
                    className="w-full bg-obsidian border border-white/10 rounded-2xl p-6 shadow-2xl relative overflow-hidden"
                >
                    {/* Background Gradient */}
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                onClick={handleExit}
                                className="w-full py-3 rounded-xl border border-white/10 text-white/60 text-sm hover:bg-white/5 hover:text-white transition-colors"
                            >
