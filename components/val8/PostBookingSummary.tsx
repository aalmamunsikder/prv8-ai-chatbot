            ...
            >
                ...
                <div className="p-6 flex-1 flex flex-col gap-6 overflow-y-auto no-scrollbar">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            <span className="text-xs text-white/40 uppercase tracking-wider">Check In</span>
                            <p className="text-white font-medium">Dec 12</p>
                            <span className="text-xs text-white/40">15:00</span>
                        </div>
                        <div className="space-y-1">
                            <span className="text-xs text-white/40 uppercase tracking-wider">Check Out</span>
                            <p className="text-white font-medium">Dec 16</p>
                            <span className="text-xs text-white/40">11:00</span>
                        </div>
                    </div>

                    <div className="space-y-3 pt-4 border-t border-white/5">
                        <h4 className="text-sm font-medium text-white/80">Enhance Your Stay</h4>
                        {[
                ...
                <div className="p-4 bg-black/20 border-t border-white/5 flex gap-2">
                    <button
                        ...
                        className="flex-1 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white/80 text-sm font-medium transition-colors border border-white/5"
                    >
                        Return to Chat
                    </button>
                    <button className="w-12 flex items-center justify-center rounded-xl bg-white/5 hover:bg-white/10 text-white/60 hover:text-white transition-colors border border-white/5">
