                ...
                {cards.map((card, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="absolute w-[90%] h-[380px] bg-obsidian border border-white/10 rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] cursor-grab active:cursor-grabbing ring-1 ring-white/5"
                        ...
                        >
                            ...
                            {/* Content */}
                            <div className="p-5 flex flex-col justify-between h-[40%] bg-obsidian/95 backdrop-blur-xl relative">
                                {/* Decorative glow */}
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    <div>
                                        ...
                                        <p className="text-champagne-400 font-medium">{card.price} <span className="text-xs text-white/40 font-light">/ night</span></p>
                                    </div>
                                    <button
                                        onClick={() => onSelect(card)}
                                        className="w-10 h-10 rounded-full bg-champagne-400 flex items-center justify-center hover:bg-champagne-300 transition-all hover:scale-105 active:scale-95 text-obsidian shadow-[0_0_20px_rgba(212,175,55,0.3)]"
                                    >
