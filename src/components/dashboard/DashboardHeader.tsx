            ...
            <div className="flex items-center gap-6">
                ...
                <div className="relative">
                    <button
                        ...
                        className={`relative text-white/40 hover:text-white transition-colors ${activeDropdown === 'notifications' ? 'text-white' : ''}`}
                    >
                        ...
                        <>
                            ...
                            <div className="absolute right-0 top-full mt-4 w-80 bg-[#0A0A0A] border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                ...
                                <div className="p-3 text-center bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
                                    <span className="text-xs text-white/60">View all notifications</span>
                                </div>
                            </div>
                        </>
                    )}
                ...
                <div className="relative">
                    ...
                    >
                        <div className="text-right hidden sm:block">
                            <p className="text-sm font-medium text-white group-hover:text-primary transition-colors">{user?.name || 'Member'}</p>
                        ...
                        <>
                            ...
                            <div className="absolute right-0 top-full mt-4 w-56 bg-[#0A0A0A] border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                <div className="p-4 border-b border-white/5 bg-white/5">
                                    <p className="text-white text-sm font-medium">{user?.email || 'member@lumina.com'}</p>
                                    <p className="text-white/40 text-xs mt-1">Noir Member #8821</p>
                                </div>
                                <div className="p-2">
