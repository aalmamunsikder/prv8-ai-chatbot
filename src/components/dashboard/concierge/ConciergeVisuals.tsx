...
export const ConciergeVisuals: React.FC<ConciergeVisualsProps> = ({ mode, demoStep }) => {
        ...
        return (
            <div className="h-full w-full flex flex-col p-6 overflow-hidden relative glass-card rounded-3xl">
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center space-y-6">
                    <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center border border-white/10 shadow-xl backdrop-blur-md">
                        <div className="w-3 h-3 bg-primary rounded-full animate-pulse" />
                    </div>
                    <div>
                        <h2 className="text-2xl font-serif text-white mb-2">Concierge Active</h2>
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full max-w-xs">
                        <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-xs text-white/60 hover:bg-white/10 transition-colors cursor-pointer">
                            Book a flight
                        </div>
                        <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-xs text-white/60 hover:bg-white/10 transition-colors cursor-pointer">
                            Find a restaurant
    ...
    // --- DEMO MODE RENDER (Copied logic from LocalDemoCard) ---
    return (
        <div className="h-full w-full flex flex-col p-6 overflow-hidden relative glass-card rounded-3xl">
