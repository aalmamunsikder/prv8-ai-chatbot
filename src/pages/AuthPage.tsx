    ...
    return (
        <div className="min-h-screen w-full bg-bg flex relative overflow-hidden">
            ...
            <div className="hidden lg:flex w-1/2 flex-col justify-between items-center text-center p-16 relative z-10 border-r border-white/5 bg-white/[0.01]">
                <Link to="/" className="flex items-center gap-2 text-white/60 hover:text-white transition-colors group w-fit">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-10">
                <div className="max-w-[420px] w-full">
                    ...
                    {/* Mobile Back Button */}
                    <Link to="/" className="lg:hidden flex items-center gap-2 text-white/60 hover:text-white mb-8">
